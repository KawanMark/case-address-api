...
A filosofia que norteou o desenvolvimento foi a de **MVC**: uma arquitetura limpa e conhecida, código de alta qualidade, e um foco especial em diferenciais técnicos como tratamento de erros robusto, cache de performance e uma estratégia de testes completa, demonstrando uma linha de pensamento orientada à qualidade e manutenibilidade.
...
A escolha foi deliberada para manter a simplicidade e clareza, alinhada às melhores práticas para APIs REST com Spring Boot. Em vez de padrões mais complexos que adicionariam sobrecarga desnecessária para o escopo do problema, optou-se por uma arquitetura que favorece:
...
-   **RF02:** Na resposta ao usuário, os campos `IBGE`, `GIA`, `DDD` e `Siafi` são removidos.
...
-   **Java 21**
-   **Spring Boot 3.5.5** (com Spring Web e Spring Data Redis)
